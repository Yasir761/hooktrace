...
#         # =========================
#         try:
#             result = asyncio.run(route_webhook_to_targets(
#                 user_id=user_id,
#                 webhook_data=payload,
#                 provider=row["provider"],
#             )
...
#                     """
#                     UPDATE webhook_events
#                     SET status='retrying', last_error=:error
#                     WHERE id=:id
#                 """
#                 ),
#                 {"id": event_id, "error": str(e)},
    ...
    while True:
        ...
        try:
            ...
            for rule in rules:
                ...
                should_process = (
                    (window_ms > 0 and time_passed >= window_ms)
                    or len(items) >= max_size
                    or time_passed > 10000
                )
