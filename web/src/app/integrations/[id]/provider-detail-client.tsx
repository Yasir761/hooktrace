...
export default function ProviderDetailClient({
  ...
  const webhookUrl = `https://hooktrace.app/webhook/${user.email.split("@")[0]}/${provider.id}`
  ...
  const handleConnect = () => {
    // In production, call your backend to create integration
    alert("Connect integration - implement backend call")
  }
