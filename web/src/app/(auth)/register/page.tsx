...
import { Mail, Lock, Github, Zap, Shield, BarChart3 } from "lucide-react"
          ...
          <div className="space-y-8 max-w-md">
            <div>
              <h2 className="text-4xl font-bold mb-4 leading-tight">
                Monitor webhooks like never before
              </h2>
              <p className="text-lg text-muted-foreground">
                Debug, track, and analyze webhook deliveries in real-time. Built for developers who care about reliability.
              </p>
            </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Start monitoring webhooks in minutes
            </p>
          </div>
